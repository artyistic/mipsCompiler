...
public class Codegen {
    ...
    private static HashMap<String, String> stringHashMap = new HashMap<String, String>(); // String-label pairs

    public static void addString(String string, String label){
        stringHashMap.put(string, label);
    }

    public static boolean hasString(String string){
        return stringHashMap.containsKey(string);
    }

    public static String getLabel(String string){
        if(Codegen.hasString(string)){
            return stringHashMap.get(string);
        }
        return null;
    }
